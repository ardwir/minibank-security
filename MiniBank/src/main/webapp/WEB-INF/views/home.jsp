...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      <li><a><span class="glyphicon glyphicon-user"></span> Hi, ${nama}</a></li>
      <li><a href="logout"><span class="glyphicon glyphicon-log-out"></span> Keluar</a></li>
    </ul>
  </div>
</nav>
<div class="wrapper">
    ...
    <div class="container">
    	<div class="content">
    	<h3>Hi, ${nama}	Selamat Datang !</h3>
    	<hr style="color:blue">
    	<img style="width:100%" src="jpeg">
    	</div>
    </div>
